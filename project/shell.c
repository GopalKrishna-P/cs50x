...
int is_directory(const char *path)
{
   ...
   return (stat(path, &path_stat) != 0)?0:S_ISDIR(path_stat.st_mode);
}
...
int main()
{
	...
	char * pch;
	char approved;
	char cwd[BUF_LEN], path[BUF_LEN];
	char inp_f[BUF_LEN], out_f[BUF_LEN];
